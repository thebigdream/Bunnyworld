...
var random = {
  ...
  */
  string: (length, characters = allCharacters) => {
    let result = "";
   ...
   */
  date: (minData, maxDate) => {
    const min = minData ? new Date(minData).getTime() : 0;
    const max = maxDate ? new Date(maxDate).getTime() : Date.now() + 1e11;
   ...
   */
  symbol: () => Symbol(random.string(10)),
  /**
  ...
  */
   ...
   */
  elementFromArray: (array) => array[random.number(0, array.length - 1)],
  /**
  ...
  keyFromObject: (object) => {
    ...
    return keys[random.number(0, keys.length - 1)];
  },
  /**
  ...
  object: (object) => {
    ...
    Object.keys(object).forEach((key) => {
      ...
      switch (typeof element) {
        case "number":
          randomObject[key] = random.number(0, 100);
          break;
        case "string":
          randomObject[key] = random.string(random.number(0, 10));
          break;
        case "boolean":
          randomObject[key] = random.boolean();
          break;
        case "symbol":
          throw new Error("Symbol is not supported at the moment");
        case "bigint":
          randomObject[key] = random.bigint(0n, 100n);
          break;
        case "object":
          if (Array.isArray(element))
            randomObject[key] = random.array(10, "number");
          else if (element instanceof Date)
            randomObject[key] = random.date();
          else if (element === null)
            randomObject[key] = null;
          else
            randomObject[key] = random.object(element);
          break;
        case "undefined":
          randomObject[key] = void 0;
          break;
        case "function":
